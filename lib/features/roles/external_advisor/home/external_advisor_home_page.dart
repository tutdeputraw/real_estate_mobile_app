...
class ExternalAdvisorHomePage extends StatelessWidget {
  const ExternalAdvisorHomePage({super.key});
        ...
        child: Column(
          ...
          children: const [
            OwnerBuyerHomeButton(
              ...
              routePath: PageNames.EXTERNAL_ADVISOR_REAL_ESTATE_OPEN_TO_SELL,
            )
          ],
        ),
      ),
